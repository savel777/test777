...
public class FormTest {
    ...
    public static String FirstName = "Prisacaru";
    public static String LastName = "Savelie";
    public static String Email = "savapr888@gmail.com";
    public static String Gender = "Male";
    public static String NUMBER = "0123456789";
    public static String DATE = "21 feb 2006";
